...
@section('content')
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto px-4 py-16 flex flex-col md:flex-row">
            <div class="flex-none">
                <img src="{{ $actor['profile_path'] }}" alt="profile_image" class="w-72">
            ...
            <div class="md:ml-24">
                ...
                <div class="flex flex-wrap items-center text-gray-400 text-sm">
                    ...
                    <span
                        class="ml-2">{{ $actor['birthday'] }}
                        ({{ $actor['age'] }} years old) in {{ $actor['place_of_birth'] }}</span>
                </div>
    ...
    <div class="credits border border-b border-gray-800">
            ...
            <ul class="list-disc leading-loose pl-5 mt-8">
                @foreach($credits as $credit)
                    <li>
                        ...
                        <strong><a href="{{ route('movie.show', $credit['id']) }}" class="hover:underline">
                                {{ $credit['title'] }}
                            </a>
                        </strong> as{{ $credit['character'] }}
                    </li>
